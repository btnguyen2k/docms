...
function configRoutes() {
    return [
        ...
        },
        {
            ...
            component: () => import('@/tpl-coderdocs/components/Search'),
        },
        {
            path: '/_tagsearch', name: 'TagSearch', meta: {label: i18n.global.t('search')},
            component: () => import('@/tpl-coderdocs/components/TagSearch'),
        },
        {
            ...
            children: [
                {
                    ...
                    component: () => import('@/tpl-coderdocs/components/Home'),
                },
                {
                ...
                },
                {
                    ...
                    component: () => import('@/tpl-coderdocs/components/Topic'),
                },
                {
                ...
                },
                {
                    ...
                    component: () => import('@/tpl-coderdocs/components/Document'),
                }
            ]
        },
    ]
